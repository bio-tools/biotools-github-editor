...
},{"./helpers/bind":"../node_modules/axios/lib/helpers/bind.js"}],"../node_modules/axios/lib/helpers/normalizeHeaderName.js":[function(require,module,exports) {
'use strict';
...
},{"./../utils":"../node_modules/axios/lib/utils.js","./transformData":"../node_modules/axios/lib/core/transformData.js","../cancel/isCancel":"../node_modules/axios/lib/cancel/isCancel.js","../defaults":"../node_modules/axios/lib/defaults.js"}],"../node_modules/axios/lib/helpers/isAbsoluteURL.js":[function(require,module,exports) {
'use strict';
...
},{"./../defaults":"../node_modules/axios/lib/defaults.js","./../utils":"../node_modules/axios/lib/utils.js","./InterceptorManager":"../node_modules/axios/lib/core/InterceptorManager.js","./dispatchRequest":"../node_modules/axios/lib/core/dispatchRequest.js","./../helpers/isAbsoluteURL":"../node_modules/axios/lib/helpers/isAbsoluteURL.js","./../helpers/combineURLs":"../node_modules/axios/lib/helpers/combineURLs.js"}],"../node_modules/axios/lib/cancel/Cancel.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../node_modules/ms/index.js":[function(require,module,exports) {
/**
 * Helpers.
 */
...
},{"./debug":"../node_modules/debug/src/debug.js","process":"../node_modules/process/browser.js"}],"../node_modules/js-base64/base64.js":[function(require,module,exports) {
...
},{}],"../node_modules/github-api/dist/components/Requestable.js":[function(require,module,exports) {
'use strict';
...
},{"axios":"../node_modules/axios/index.js","debug":"../node_modules/debug/src/browser.js","js-base64":"../node_modules/js-base64/base64.js"}],"../node_modules/github-api/dist/components/Gist.js":[function(require,module,exports) {
'use strict';
...
},{"./Requestable":"../node_modules/github-api/dist/components/Requestable.js"}],"../node_modules/github-api/dist/components/User.js":[function(require,module,exports) {
'use strict';
...
},{"./Requestable":"../node_modules/github-api/dist/components/Requestable.js","debug":"../node_modules/debug/src/browser.js"}],"../node_modules/github-api/dist/components/Issue.js":[function(require,module,exports) {
'use strict';
...
},{"./Requestable":"../node_modules/github-api/dist/components/Requestable.js"}],"../node_modules/github-api/dist/components/Search.js":[function(require,module,exports) {
'use strict';
...
},{"./Requestable":"../node_modules/github-api/dist/components/Requestable.js","debug":"../node_modules/debug/src/browser.js"}],"../node_modules/github-api/dist/components/RateLimit.js":[function(require,module,exports) {
'use strict';
...
},{"./Requestable":"../node_modules/github-api/dist/components/Requestable.js"}],"../node_modules/utf8/utf8.js":[function(require,module,exports) {
var global = arguments[3];
var define;
...
},{"base64-js":"../node_modules/base64-js/index.js","ieee754":"../node_modules/ieee754/index.js","isarray":"../node_modules/isarray/index.js","buffer":"../node_modules/buffer/index.js"}],"../node_modules/github-api/dist/components/Repository.js":[function(require,module,exports) {
...
},{"./Requestable":"../node_modules/github-api/dist/components/Requestable.js","utf8":"../node_modules/utf8/utf8.js","js-base64":"../node_modules/js-base64/base64.js","debug":"../node_modules/debug/src/browser.js","buffer":"../node_modules/buffer/index.js"}],"../node_modules/github-api/dist/components/Organization.js":[function(require,module,exports) {
'use strict';
...
},{"./Requestable":"../node_modules/github-api/dist/components/Requestable.js"}],"../node_modules/github-api/dist/components/Team.js":[function(require,module,exports) {
'use strict';
...
},{"./Requestable":"../node_modules/github-api/dist/components/Requestable.js","debug":"../node_modules/debug/src/browser.js"}],"../node_modules/github-api/dist/components/Markdown.js":[function(require,module,exports) {
'use strict';
...
},{"./Requestable":"../node_modules/github-api/dist/components/Requestable.js"}],"../node_modules/github-api/dist/components/Project.js":[function(require,module,exports) {
'use strict';
...
},{"./Requestable":"../node_modules/github-api/dist/components/Requestable.js"}],"../node_modules/github-api/dist/components/GitHub.js":[function(require,module,exports) {
'use strict';
...
},{"./Gist":"../node_modules/github-api/dist/components/Gist.js","./User":"../node_modules/github-api/dist/components/User.js","./Issue":"../node_modules/github-api/dist/components/Issue.js","./Search":"../node_modules/github-api/dist/components/Search.js","./RateLimit":"../node_modules/github-api/dist/components/RateLimit.js","./Repository":"../node_modules/github-api/dist/components/Repository.js","./Organization":"../node_modules/github-api/dist/components/Organization.js","./Team":"../node_modules/github-api/dist/components/Team.js","./Markdown":"../node_modules/github-api/dist/components/Markdown.js","./Project":"../node_modules/github-api/dist/components/Project.js"}],"../node_modules/jquery/dist/jquery.js":[function(require,module,exports) {
var global = arguments[3];
var process = require("process");
var define;
/*!
...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/superagent/node_modules/component-emitter/index.js":[function(require,module,exports) {
...
var OAUTH = sessionStorage.getItem("access_token"); // If the user is here without OAUTH token, redirect to connexion page
...
gh.getUser().getProfile(function (err, profile) {
  if (!profile) {
    ...
    var $login = (0, _jquery.default)('#username');
    var $avatar = (0, _jquery.default)('#avatar');
    $login.text(login);
...
var $btn_search = (0, _jquery.default)('.btn_search');
var $btn_select = (0, _jquery.default)('.btn_select');
var $btn_search_other = (0, _jquery.default)('.btn_search_other');
var $btn_send = (0, _jquery.default)('.btn_send');
var $btn_cancel = (0, _jquery.default)('.btn_cancel');
$btn_search.on('click', function (event) {
  // Input text to search a tool
  search_tool((0, _jquery.default)('#search_tool'));
});
$btn_select.on('click', function (event) {
  // Select tag to choose the tool to search
  search_tool((0, _jquery.default)('#tool_list'));
});
...
function add_tab_event() {
  var $tab_not_active = (0, _jquery.default)("li:not('.active')");
...
function show_loader() {
  var $loader = (0, _jquery.default)('#search_loader');
  $loader.show();
}
...
function search_tool($search_tool, _cb) {
  ...
  if (tool_name != "") {
    show_loader(); // Get the corresponding json file on the data repository on Github (Cf Github authentifiation above)
    ...
    repo.getContents('master', 'data/' + tool_name + '/' + tool_name + '.json', true, function (req, res) {
      if (!res) {
        ...
        modif_mode(); // Store the master json entry in memory to manipulate the entry later

        store_entry(res); // Print the master entry into html

        print_branch_content(res, tool_name); // Search and print the other version of the entry into other tabs
...
function print_branch_content(entry, name) {
  ...
  console.log("entry: " + name); // Store the current mode to "print"

  store_entry("print", "mode"); // Store the current state of changes to false

  store_entry(false, "changes"); //store_modif([]); //WIP: Try to store the modif added to the tool
...
function print_tool(entry) {
  ...
  var $tool_content = (0, _jquery.default)('#tool_content'); // Erase content

  $tool_content.html(""); // For every data of the tool entry, print it in a line in the table
  ...
  var $title = (0, _jquery.default)('p#title');
  $title.text(entry['biotoolsID']); // Table cell that could be modified are selected thanks to the id "value"
  //var $modifcell = $('p.value');

  var $modifcell = (0, _jquery.default)('td.edit');
  ...
  var $new_line = (0, _jquery.default)('td.new_line');
...
function val_to_table(entry) {
  var id = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  var value_to_print = ""; // If there is an empty entry, create a cell with the 'new' class and a cell with a blank indicator
  ...
  if (entry == "" || entry == null) {
    ...
    //   ELSE create a cell with the 'value' class and a blue indicator (meaning 'unmodified')
        ...
        if (id == "") {
          ...
          value_to_print += "<p id=\"" + id + "\" class=value>"; //TODO En faire une fonction :
          // Faire regex
          // Si ~http://edamontology.org faire un lien <A>
          //

          var regex_website = /^http[s]?:\/\/\S*$/; // Start with 'http(s)://' and don't have whitespace after (i.e. no other words)
...
function modif_dict(entry, pos, tab_pos, value) {
  ...
  new_tab_pos.shift();
  var new_entry = entry; // While we don't arrived to the end of the table we relaunch the function with next pos entry (deeper in the dict) 
...
function modif_value(id) {
  var motif = /___/; // Get the position liste of the value from the id (Cf. "val_to_table")

  var liste = id.split(motif); // Select the tag with this id

  var $value = (0, _jquery.default)('#' + id); // Get the original value on this tag
  ...
  edit_mode(function () {
    ...
    var $value = (0, _jquery.default)('#' + id);
    $value.replaceWith(new_html); // Change the indicator status to have a clickable symbol to validate the modification

    var $value_status = (0, _jquery.default)('#' + id + '_status');
    var new_html = "<td id=\"" + id + "_status\" class=valid >✔️</td>";
    $value_status.replaceWith(new_html);
    var $value_status = (0, _jquery.default)('#' + id + '_status'); // Function to manage modification of the value

    $value_status.on('click', function (event) {
      var $value_new = (0, _jquery.default)('#' + id);
      var new_v = $value_new.val(); // If the value is different from the original
      // we store it and change the status to "new"

      if (orig_v != new_v) {
        // Retrieve stored entry
        var entry_id = (0, _jquery.default)('li.active').attr('id');
        var entry = get_stored_entry(entry_id);
        console.log(entry); //var liste_modif=Array.from(liste); // WIP

        entry = modif_dict(entry, liste[0], liste, new_v);
        console.log(entry);
        store_entry(entry, entry_id); // Changes have been made, we record the status to true and show the btn to send changes into PR

        store_entry(true, "changes");
        var $btn_send = (0, _jquery.default)('input.btn_send');
        var $btn_cancel = (0, _jquery.default)('input.btn_cancel');
        $btn_send.show();
        $btn_cancel.show(); // WIP WIP WIP WIP WIP WIP WIP WIP WIP WIP WIP
      ...
      $value_status.replaceWith(new_html); // Rebind the modif function to the tag
...
function edit_mode(_cb) {
  if (get_stored_entry("mode") != "edit") {
    ...
    var current_tool = (0, _jquery.default)('li.active').attr('id');
...
function send_modif() {
  ...
  var my_bt_entry = JSON.stringify(entry, null, " "); // 2)
...
function modif_mode() {
  var $search_table = (0, _jquery.default)('.search_table');
  $search_table.hide();
  var $modif_table = (0, _jquery.default)('.modif_table');
  $modif_table.show();
  var $tab_menu = (0, _jquery.default)('#menu');
  $tab_menu.show();
}
...
function search_mode() {
  var $tool_content = (0, _jquery.default)('#tool_content');
  $tool_content.html("");
  var $title = (0, _jquery.default)('p#title');
...
function get_stored_entry() {
  var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "new_entry";
  var stored = sessionStorage.getItem(name);
  if (stored) return JSON.parse(stored);else return false; // TODO manage this false return for callers
} // /////////////////
// STORE_ENTRY 
...
function store_entry(entry) {
  var name = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "new_entry";
...
function fill_tool_list() {
  var $tool_list_obj = (0, _jquery.default)('#tool_list');
  repo.getContents('master', 'index.txt', true, function (req, res) {
    ...
    var $btn_select = (0, _jquery.default)('.btn_select');
    $btn_select.show();
    var $option_not_found = (0, _jquery.default)("#tool_list option[id='not_found']");
...
function add_tab(id) {
  var value = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : id;
  var $tab = (0, _jquery.default)('#tab');
...
function visual_select_tab(id) {
  var $tab = (0, _jquery.default)('#' + id);
  var $tab_active = (0, _jquery.default)('li.active');
  ...
  var status_converter = {
    "PR": "[Existing Pull Request]",
    "new": "[New Pull Request]",
    "edit": "[Edit mode]"
  };
  var status_long = status_converter[status];
  var $github_link = (0, _jquery.default)('a#github_link');
  $github_link.hide();
...
function create_tabs(tool) {
  add_tab(tool); // TODO Change this visual selct by a change_tab (and remove the print tool from the functions that calls create_tabs)
...
function change_tab(id_tab_selected) {
  ...
  var $tab_selected = (0, _jquery.default)('#' + id_tab_selected);
...
// WIP WIP WIP WIP WIP WIP WIP WIP WIP WIP WIP WIP WIP
// ////////////////////////////////////////////////////
},{"github-api":"../node_modules/github-api/dist/components/GitHub.js","jquery":"../node_modules/jquery/dist/jquery.js","superagent":"../node_modules/superagent/lib/client.js","fs":"../node_modules/parcel-bundler/src/builtins/_empty.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];

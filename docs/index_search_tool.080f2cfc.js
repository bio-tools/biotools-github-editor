...
var repo = gh.getRepo('ValentinMarcon', 'TESTAPI'); // Init metadata var
...
if (tool_on_url) {
  ...
  (0, _jquery.default)('#search_tool').val(tool_on_url); // WIP window.location.href = "tool.html?"+tool_on_url;
  ...
  if (tool_name != "") {
    ...
    repo.getContents('master', 'data/' + tool_name + '/' + tool_name + '.json', true, function (req, res) {
      if (!res) {
        ...
        modif_mode();
        tool_metadata["name"] = tool_name; //addOrUpdateUrlParameter('tool',tool_name);
        // Store the master json entry in memory to manipulate the entry later

        store_entry(res); // Store the json entry in memory to manipulate the entry later

        store_entry(res, tool_name); //console.log("entry: "+name);
        // Print the master entry into html

        print_branch_content(res, tool_name); // Search the other version of the entry and print corresponding tabs
  ...
  repo.listPullRequests({}, function (req, res) {
    ...
    res.forEach(function (pullrequest) {
      ...
      if (regex.test(branch_name_lc)) {
        ...
        var new_name = "PR_" + pr_number + "_" + tool_name; // INIT tool_metadata[id_tool]
        ...
        get_branch_content(branch_name, tool_name, my_repo, function (entry) {
          if (entry) {
            ...
            store_entry(entry, new_name); //console.log("entry: "+name);
...
function print_tool(entry) {
  ...
  $title.text(tool_metadata["name"]); // Table cell that could be modified are selected thanks to the id "value"
  ...
  edit_mode(function () {
    ...
    $value_status.on('click', function (event) {
      ...
      if (orig_v != new_v) {
        ...
        var entry = get_stored_entry(entry_id); //var liste_modif=Array.from(liste); // WIP
...
function send_modif() {
  ...
  console.log(entry + " changes will be recorded"); // Lower Case id of the tool

  var tool_name = tool_metadata["name"].toLowerCase(); // File name in which changes will be saved

  var file_name = tool_name + ".json"; // Path of the file in github

  var file_path = "data/" + tool_name + "/" + file_name; // Current date

  var d = new Date();
  var now = d.getFullYear() + "-" + (d.getMonth() + 1) + "-" + d.getDate() + "-" + d.getHours() + "-" + d.getMinutes() + "-" + d.getSeconds() + "-" + d.getMilliseconds(); // Branch name with current date and 'new' tag

  var branch_name = "new_" + tool_name + "_" + now; // Origin branch in which the Fork and Pull Request will be done

  var branch_origin = "dev"; // Convert the entry to JSON to record it on the json file
  ...
  repo.fork(function (req, res) {
    ...
    var repo_forked = gh.getRepo(login, repo_name); // 3)
          ...
          if (!res) {
            ...
            var result = repo.createPullRequest({
              ...
              if (!res) {
                ...
                tool_metadata[new_name] = {};
                tool_metadata[new_name]['pr_link'] = res["html_url"]; // Store the json entry in memory to manipulate the entry later
...
function visual_select_tab(id) {
  ...
  add_tab_event();
  var $title = (0, _jquery.default)('p#title');
  var $subtitle = (0, _jquery.default)('a#subtitle');
...
// WIP WIP WIP WIP WIP WIP WIP WIP WIP WIP WIP WIP WIP
// ////////////////////////////////////////////////////
},{"github-api":"../node_modules/github-api/dist/components/GitHub.js","jquery":"../node_modules/jquery/dist/jquery.js","superagent":"../node_modules/superagent/lib/client.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index_search_tool.js"], null)
//# sourceMappingURL=/index_search_tool.080f2cfc.js.map